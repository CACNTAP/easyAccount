...
<html lang="en">
    <head>
        ...
        <!-- google font -->
        <link href="<%=request.getContextPath()%>/http://fonts.googleapis.com/css?family=Aclonica:regular" rel="stylesheet" type="text/css" />

        <!-- styles -->
        <link href="<%=request.getContextPath()%>/css/bootstrap.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/css/bootstrap-responsive.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/css/stilearn.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/css/stilearn-responsive.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/css/stilearn-helper.css" rel="stylesheet" />
        <link href="<%=request.getContextPath()%>/css/stilearn-icon.css" rel="stylesheet" />
        ...
        <link href="<%=request.getContextPath()%>/css/bootstrap-wysihtml5.css" rel="stylesheet" />

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
          <script src="<%=request.getContextPath()%>/http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <![endif]-->
    ...
    <body>
                        ...
                        <div class="panel-ext">
                                ...
                                <ul class="dropdown-menu dropdown-notification">
                                    ...
                                    <li class="new">
                                        <a href="#">
                                            ...
                                            <div class="media">
                                                <img class="media-object pull-left" data-src="<%=request.getContextPath()%>/js/holder.js/64x64" />
                            ...
                            <div class="btn-group user-group">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    <img class="corner-all" align="middle" src="<%=request.getContextPath()%>/img/user-thumb.jpg" title="John Doe" alt="john doe" /> <!--this for display on PC device-->
                                    ...
                                    <li>
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img class="img-circle" src="<%=request.getContextPath()%>/img/user.jpg" title="profile" alt="profile" />
                                            </a>
                        ...
                        <ul class="sidebar">
                            ...
                            <li>
                                <a href="interface.html" title="interface">
                                    ...
                                    <span class="sidebar-text">流水</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="charts.html" title="charts">
                                    ...
                                    <span class="sidebar-text">账户</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<%=request.getContextPath() %>/planMng/toPlan.do" title="grids">
                                    <div class="helper-font-24">
                                        <i class="icofont-columns"></i>
                                    </div>
                                    <span class="sidebar-text">计划</span>
                                </a>
                            </li>
                        </ul>
                    </aside><!--/side bar -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="recent-orders">
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object" data-src="<%=request.getContextPath()%>/js/holder.js/64x64" />
                                                        </a>
                                                        <div class="media-body">
                                                ...
                                                <li class="contact-alt grd-white">
                                                    ...
                                                    <a href="#chat" data-toggle="tab" data-id="iin@mail.com">
                                                        ...
                                                        <div class="contact-item">
                                                            <div class="pull-left">
                                                                <img class="contact-item-object" style="width: 32px;height: 32px;" src="<%=request.getContextPath()%>/img/user-thumb-mini.jpg" />
                                                            </div>
                                        ...
                                        <div class="side-task">
                                            <div class="task active">
                                                <span class="task-header">
                                                    <img src="<%=request.getContextPath()%>/img/loader_16.gif" /> 
        ...
        <!-- javascript
        ================================================== -->
        <script type="text/javascript" src="<%=request.getContextPath()%>/http://platform.twitter.com/widgets.js"></script>
        <script src="<%=request.getContextPath()%>/js/jquery.js"></script>
        <script src="<%=request.getContextPath()%>/js/jquery-ui.min.js"></script>
        <script src="<%=request.getContextPath()%>/js/bootstrap.js"></script>
        <script src="<%=request.getContextPath()%>/js/uniform/jquery.uniform.js"></script>
        <script src="<%=request.getContextPath()%>/js/peity/jquery.peity.js"></script>
        ...
        <script src="<%=request.getContextPath()%>/js/flot/jquery.flot.categories.js"></script>
        <script src="<%=request.getContextPath()%>/js/wysihtml5/wysihtml5-0.3.0.js"></script>
        <script src="<%=request.getContextPath()%>/js/wysihtml5/bootstrap-wysihtml5.js"></script>
        <script src="<%=request.getContextPath()%>/js/calendar/fullcalendar.js"></script> <!-- this plugin required jquery ui-->

        <!-- required stilearn template js, for full feature-->
        <script src="<%=request.getContextPath()%>/js/holder.js"></script>
        <script src="<%=request.getContextPath()%>/js/stilearn-base.js"></script>
