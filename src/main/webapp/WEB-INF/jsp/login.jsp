...
<html lang="en">
    ...
    <body>
                ...
                <div class="signin-form row-fluid">
                    ...
                    <div class="span5 offset1">
                        <div class="box corner-all">
                            ...
                            <div class="box-body bg-white">
                                <form id="sign-in" method="post" action="loginMng/login.do"/>
                                    <div class="control-group">
                                        <label class="control-label">Username</label>
                                        <div class="controls">
                                            <input type="text" name="loginName" class="input-block-level" data-validate="{required: true, messages:{required:'Please enter field username'}}" name="login_username" id="login_username" autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Password</label>
                                        <div class="controls">
                                            <input type="password" name="loginPwd" class="input-block-level" data-validate="{required: true, messages:{required:'Please enter field password'}}" name="login_password" id="login_password" autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                    ...
                    <div class="span5">
                        <div class="box corner-all">
                            ...
                            <div class="box-body bg-white">
                                <form id="sign-up" method="post" action="<%=request.getContextPath()%>/loginMng/register.do" />
                                    <div class="control-group">
                                        <label class="control-label">Username</label>
                                        <div class="controls">
        ...
        <script src="<%=request.getContextPath()%>/<%=request.getContextPath()%>/js/uniform/jquery.uniform.js"></script>
        
        <script src="<%=request.getContextPath()%>/<%=request.getContextPath()%>/js/validate/jquery.metadata.js"></script>
        <script src="<%=request.getContextPath()%>/<%=request.getContextPath()%>/js/validate/jquery.validate.js"></script>
